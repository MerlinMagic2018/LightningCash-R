...
LITECOINCASHD=${LITECOINCASHD:-$SRCDIR/lightningcashrd}
LITECOINCASHCLI=${LITECOINCASHCLI:-$SRCDIR/lightningcashr-cli}
LITECOINCASHTX=${LITECOINCASHTX:-$SRCDIR/lightningcashr-tx}
LITECOINCASHQT=${LITECOINCASHQT:-$SRCDIR/qt/lightningcashr-qt}
