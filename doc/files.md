...
* lightningcashr.conf: contains configuration settings for lightningcashrd or lightningcashr-qt
* lightningcashrd.pid: stores the process id of lightningcashrd while running
...
* debug.log: contains debug information and general logging generated by lightningcashrd or lightningcashr-qt
