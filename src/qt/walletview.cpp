...
#include <qt/hivedialog.h>      // LightningCashr: Hive page
...
#include <boost/thread.hpp>     // LightningCashr: Key import helper
#include <wallet/rpcwallet.h>   // LightningCashr: Key import helper
#include <wallet/wallet.h>      // LightningCashr: Key import helper
#include <validation.h>         // LightningCashr: Key import helper
...
#include <QPushButton>
#include <QVBoxLayout>
#include <QInputDialog>         // LightningCashr: Key import helper
    ...
    platformStyle(_platformStyle)
{
    ...
    hivePage = new HiveDialog(platformStyle); // LightningCashr: Hive page
    ...
    addWidget(hivePage);   // LightningCashr: Hive page
...
void WalletView::setBitcoinGUI(BitcoinGUI *gui)
{
    if (gui)
    {
        ...
        // LightningCashr: Go to hive page if bee button on overview clicked
        ...
        // LightningCashr: Hive: Connect hive status update signal
...
void WalletView::setClientModel(ClientModel *_clientModel)
{
    ...
    hivePage->setClientModel(_clientModel); // LightningCashr: Hive page
}
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    hivePage->setModel(_walletModel);         // LightningCashr: Hive page
...
// LightningCashr: Hive: Unlock wallet just for hive
...
void WalletView::importPrivateKey()
{
    ...
    if (ok && !privKey.isEmpty()) {
        ...
        if (!vchSecret.SetString(privKey.toStdString())) {
            QMessageBox::critical(0, tr(PACKAGE_NAME), tr("This doesn't appear to be a Lightning/LightningCashr private key."));
            return;
        }
