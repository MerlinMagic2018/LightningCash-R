...
#include <qt/hivetablemodel.h>  // LightningCashr: Hive
#include <qt/hivedialog.h>      // LightningCashr: Hive: For formatLargeNoLocale()
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    if(model && model->getOptionsModel())
    {
        ...
        // LightningCashr: Hive: Connect summary updater
...
// LightningCashr: Hive: Update the hive summary
...
void OverviewPage::updateDisplayUnit()
{
    if(walletModel && walletModel->getOptionsModel())
    {
        ...
        // LightningCashr: Hive: Update CAmounts in hive summary
        ui->rewardsPaidLabel->setText(
            BitcoinUnits::format(walletModel->getOptionsModel()->getDisplayUnit(), rewardsPaid)
            + " "
            + BitcoinUnits::shortName(walletModel->getOptionsModel()->getDisplayUnit())
...
// LightningCashr: Hive: Handle bee button click
